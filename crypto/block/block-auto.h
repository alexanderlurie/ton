...
struct BurningConfig final : TLB_Complex {
  ...
  bool validate_skip(int* ops, vm::CellSlice& cs, bool weak = false) const override;
  bool unpack(vm::CellSlice& cs, Record& data) const;
  bool unpack_burning_config(vm::CellSlice& cs, Ref<CellSlice>& blackhole_addr, int& fee_burn_nom, int& fee_burn_denom) const;
  bool cell_unpack(Ref<vm::Cell> cell_ref, Record& data) const;
  bool cell_unpack_burning_config(Ref<vm::Cell> cell_ref, Ref<CellSlice>& blackhole_addr, int& fee_burn_nom, int& fee_burn_denom) const;
  bool pack(vm::CellBuilder& cb, const Record& data) const;
  bool pack_burning_config(vm::CellBuilder& cb, Ref<CellSlice> blackhole_addr, int fee_burn_nom, int fee_burn_denom) const;
  bool cell_pack(Ref<vm::Cell>& cell_ref, const Record& data) const;
  bool cell_pack_burning_config(Ref<vm::Cell>& cell_ref, Ref<CellSlice> blackhole_addr, int fee_burn_nom, int fee_burn_denom) const;
  bool print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const override;
  std::ostream& print_type(std::ostream& os) const override {
...
struct BurningConfig::Record {
  ...
  int fee_burn_nom;  	// fee_burn_nom : #
  int fee_burn_denom;  	// fee_burn_denom : #
  Record() = default;
  Record(Ref<CellSlice> _blackhole_addr, int _fee_burn_nom, int _fee_burn_denom) : blackhole_addr(std::move(_blackhole_addr)), fee_burn_nom(_fee_burn_nom), fee_burn_denom(_fee_burn_denom) {}
};
...
struct SizeLimitsConfig::Record_size_limits_config_v2 {
  ...
  Record_size_limits_config_v2(unsigned _max_msg_bits, unsigned _max_msg_cells, unsigned _max_library_cells, int _max_vm_data_depth, unsigned _max_ext_msg_size, int _max_ext_msg_depth, unsigned _max_acc_state_cells, unsigned _max_acc_state_bits) : max_msg_bits(_max_msg_bits), max_msg_cells(_max_msg_cells), max_library_cells(_max_library_cells), max_vm_data_depth(_max_vm_data_depth), max_ext_msg_size(_max_ext_msg_size), max_ext_msg_depth(_max_ext_msg_depth), max_acc_state_cells(_max_acc_state_cells), max_acc_state_bits(_max_acc_state_bits) {}
};
